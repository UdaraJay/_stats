...
// TODO: an endpoint that returns summarized counts
// would be useful for scaling this beyond 10K events per timespan.
async function queryData(
	start: Date,
	end: Date,
	filter: string | string[] | undefined
) {
	// we need to return counts instead of whole events
